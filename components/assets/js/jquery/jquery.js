...
!function(t) {
  ...
  y.ui = y.ui || {};
  y.ui.version = "1.13.2";
  var n, i = 0, h = Array.prototype.hasOwnProperty, a = Array.prototype.slice;
  y.cleanData = (n = y.cleanData,
  function(t) {
  ...
  y.widget = function(t, i, e) {
      var s, n, o, h = {}, a = t.split(".")[0], r = a + "-" + (t = t.split(".")[1]);
      return e || (e = i,
      i = y.Widget),
      ...
      y.each(e, function(e, s) {
          ...
          h[e] = "function" == typeof s ? function() {
  ...
  y.widget.extend = function(t) {
      for (var e, i, s = a.call(arguments, 1), n = 0, o = s.length; n < o; n++)
          for (e in s[n])
              i = s[n][e],
              h.call(s[n], e) && void 0 !== i && (y.isPlainObject(i) ? t[e] = y.isPlainObject(t[e]) ? y.widget.extend({}, t[e], i) : y.widget.extend({}, i) : t[e] = i);
      return t
  }
  ,
  y.widget.bridge = function(o, e) {
      ...
      y.fn[o] = function(i) {
          ...
          return t ? this.length || "instance" !== i ? this.each(function() {
              var t, e = y.data(this, h);
              return "instance" === i ? (n = e,
              !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? y.error("no such method '" + i + "' for " + o + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (n = t && t.jquery ? n.pushStack(t.get()) : t,
              !1) : void 0 : y.error("cannot call methods on " + o + " prior to initialization; attempted to call method '" + i + "'")
          }) : n = void 0 : (s.length && (i = y.widget.extend.apply(null, [i].concat(s))),
          this.each(function() {
              var t = y.data(this, h);
              t ? (t.option(i || {}),
              t._init && t._init()) : y.data(this, h, new e(i,this))
          })),
          n
      }
  }
  ...
  y.Widget.prototype = {
      ...
      option: function(t, e) {
          ...
          if ("string" == typeof t)
              ...
              t = (i = t.split(".")).shift(),
              i.length) {
                  for (s = o[t] = y.widget.extend({}, this.options[t]),
                  n = 0; n < i.length - 1; n++)
                      s[i[n]] = s[i[n]] || {},
                      s = s[i[n]];
                  if (t = i.pop(),
      ...
      _setOptionClasses: function(t) {
          ...
          for (e in t)
              ...
              t[e] !== this.options.classes[e] && s && s.length && (i = y(s.get()),
              ...
              for (var i, s = 0; s < t.length; s++)
                  ...
                  i = n.add ? (function() {
                      ...
                      n.element.each(function(t, e) {
                          y.map(h.classesElementLookup, function(t) {
                              return t
                          }).some(function(t) {
                              return t.is(e)
                          }) || i.push(e)
                  ...
                  y(y.uniqueSort(i.get().concat(n.element.get())))) : y(i.not(n.element).get()),
      ...
      _on: function(n, o, t) {
          ...
          y.each(t, function(t, e) {
              function i() {
                  if (n || !0 !== a.options.disabled && !y(this).hasClass("ui-state-disabled"))
  ...
  y.each({
      ...
      y.Widget.prototype["_" + o] = function(e, t, i) {
          var s, n = (t = "string" == typeof t ? {
              effect: t
          } : t) ? !0 !== t && "number" != typeof t && t.effect || h : o;
          "number" == typeof (t = t || {}) ? t = {
              duration: t
          } : !0 === t && (t = {}),
          s = !y.isEmptyObject(t),
          ...
          s && y.effects && y.effects.effect[n] ? e[o](t) : n !== o && e[n] ? e[n](t.duration, t.easing, i) : e.queue(function(t) {
              y(this)[o](),
              i && i.call(e[0]),
              t()
          })
  ...
  y.position = {
      scrollbarWidth: function() {
          if (void 0 !== s)
              return s;
          var t, e = y("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>"), i = e.children()[0];
          return y("body").append(e),
          t = i.offsetWidth,
  ...
  y.fn.position = function(p) {
      ...
      var d, c, f, g, m, t, _ = "string" == typeof (p = y.extend({}, p)).of ? y(document).find(p.of) : y(p.of), w = y.position.getWithinInfo(p.within), v = y.position.getScrollInfo(w), b = (p.collision || "flip").split(" "), z = {}, e = 9 === (t = (e = _)[0]).nodeType ? {
          width: e.width(),
          height: e.height(),
          offset: {
              top: 0,
      ...
      return _[0].preventDefault && (p.at = "left top"),
      c = e.width,
      f = e.height,
      ...
      1 === b.length && (b[1] = b[0]),
      "right" === p.at[0] ? m.left += c : "center" === p.at[0] && (m.left += c / 2),
      "bottom" === p.at[1] ? m.top += f : "center" === p.at[1] && (m.top += f / 2),
      d = E(z.at, c, f),
      m.left += d[0],
      m.top += d[1],
      this.each(function() {
          var i, t, h = y(this), a = h.outerWidth(), r = h.outerHeight(), e = H(this, "marginLeft"), s = H(this, "marginTop"), n = a + e + H(this, "marginRight") + v.width, o = r + s + H(this, "marginBottom") + v.height, l = y.extend({}, m), u = E(z.my, h.outerWidth(), h.outerHeight());
          "right" === p.my[0] ? l.left -= a : "center" === p.my[0] && (l.left -= a / 2),
          "bottom" === p.my[1] ? l.top -= r : "center" === p.my[1] && (l.top -= r / 2),
          l.left += u[0],
          l.top += u[1],
          i = {
              marginLeft: e,
          ...
          y.each(["left", "top"], function(t, e) {
              y.ui.position[b[t]] && y.ui.position[b[t]][e](l, {
                  targetWidth: c,
                  targetHeight: f,
                  elemWidth: a,
                  elemHeight: r,
          ...
          p.using && (t = function(t) {
              ...
              x(D(e), D(i)) > x(D(s), D(n)) ? o.important = "horizontal" : o.important = "vertical",
  ...
  y.ui.position = {
      fit: {
          left: function(t, e) {
              ...
              e.collisionWidth > n ? 0 < h && a <= 0 ? (i = t.left + h + e.collisionWidth - n - s,
              t.left += h - i) : t.left = !(0 < a && h <= 0) && a < h ? s + n - e.collisionWidth : s : 0 < h ? t.left += h : 0 < a ? t.left -= a : t.left = x(t.left - o, t.left)
          },
          top: function(t, e) {
              var i = e.within
              ...
              e.collisionHeight > n ? 0 < h && a <= 0 ? (i = t.top + h + e.collisionHeight - n - s,
              t.top += h - i) : t.top = !(0 < a && h <= 0) && a < h ? s + n - e.collisionHeight : s : 0 < h ? t.top += h : 0 < a ? t.top -= a : t.top = x(t.top - o, t.top)
          }
      },
      flip: {
          left: function(t, e) {
              var i = e.within
                ...
                , h = -2 * e.offset[0];
              a < 0 ? ((s = t.left + l + i + h + e.collisionWidth - n - s) < 0 || s < D(a)) && (t.left += l + i + h) : 0 < r && (0 < (o = t.left - e.collisionPosition.marginLeft + l + i + h - o) || D(o) < r) && (t.left += l + i + h)
          },
          top: function(t, e) {
              var i = e.within
                ...
                , h = -2 * e.offset[1];
              a < 0 ? ((s = t.top + l + i + h + e.collisionHeight - n - s) < 0 || s < D(a)) && (t.top += l + i + h) : 0 < r && (0 < (o = t.top - e.collisionPosition.marginTop + l + i + h - o) || D(o) < r) && (t.top += l + i + h)
          }
      },
      flipfit: {
          left: function() {
  ...
  y.ui.focusable = function(t, e) {
      var i, s, n, o, h = t.nodeName.toLowerCase();
      return "area" === h ? (s = (i = t.parentNode).name,
      !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && (0 < (s = y("img[usemap='#" + s + "']")).length && s.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(h) ? (n = !t.disabled) && (o = y(t).closest("fieldset")[0]) && (n = !o.disabled) : n = "a" === h && t.href || e,
      n && y(t).is(":visible") && function(t) {
  ...
  y.ui.formResetMixin = {
      ...
      _unbindFormResetHandler: function() {
          var t;
          this.form.length && ((t = this.form.data("ui-form-reset-instances")).splice(y.inArray(this, t), 1),
  ...
  y.escapeSelector || (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,
  d = function(t, e) {
  ...
  y.widget("ui.resizable", y.ui.mouse, {
      ...
      _create: function() {
          ...
          this._setupHandles(),
          e.autoHide && y(this.element).on("mouseenter", function() {
      ...
      _setupHandles: function() {
          var t, e, i, s, n, o = this.options, h = this;
          ...
          this._renderAxis = function(t) {
              ...
              this.handles)
                  this.handles[e].constructor === String ? this.handles[e] = this.element.children(this.handles[e]).first().show() : (this.handles[e].jquery || this.handles[e].nodeType) && (this.handles[e] = y(this.handles[e]),
                  this._on(this.handles[e], {
                      mousedown: h._mouseDown
                  })),
                  this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) && (i = y(this.handles[e], this.element),
      ...
      _mouseCapture: function(t) {
          ...
          for (e in this.handles)
              (i = y(this.handles[e])[0]) !== t.target && !y.contains(i, t.target) || (s = !0);
      ...
      _mouseStart: function(t) {
          ...
          s.containment && (e += y(s.containment).scrollLeft() || 0,
      ...
      _mouseDrag: function(t) {
          ...
          y.isEmptyObject(e) || (this._updatePrevProperties(),
      ...
      _mouseStop: function(t) {
          ...
          n.animate || this.element.css(y.extend(e, {
              top: s,
              left: i
          })),
      ...
      _renderProxy: function() {
          ...
          this._helper ? (this.helper = this.helper || y("<div></div>").css({
              overflow: "hidden"
          }),
  ...
  y.ui.plugin.add("resizable", "animate", {
      stop: function(e) {
          ...
          i.element.animate(y.extend(n, o && h ? {
              top: o,
              left: h
          } : {}), {
  ...
  y.ui.plugin.add("resizable", "containment", {
      start: function() {
          var i, s, n = y(this).resizable("instance"), t = n.options, e = n.element, o = t.containment, h = o instanceof y ? o.get(0) : /parent/.test(o) ? e.parent().get(0) : o;
          h && (n.containerElement = y(h),
      ...
      resize: function(t) {
          ...
          n.left < (e._helper ? s.left : 0) && (e.size.width = e.size.width + (e._helper ? e.position.left - s.left : e.position.left - h.left),
          ...
          n = Math.abs(e.sizeDiff.width + (e._helper ? e.offset.left - h.left : e.offset.left - s.left)),
          s = Math.abs(e.sizeDiff.height + (e._helper ? e.offset.top - h.top : e.offset.top - s.top)),
      ...
      stop: function() {
          ...
          t._helper && !e.animate && /relative/.test(n.css("position")) && y(this).css({
              left: h.left - s.left - i.left,
              width: a,
              height: o
          }),
          t._helper && !e.animate && /static/.test(n.css("position")) && y(this).css({
              left: h.left - s.left - i.left,
              width: a,
              height: o
          })
  ...
  y.ui.plugin.add("resizable", "grid", {
      resize: function() {
          var t, e = y(this).resizable("instance"), i = e.options, s = e.size, n = e.originalSize, o = e.originalPosition, h = e.axis, a = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid, r = a[0] || 1, l = a[1] || 1, u = Math.round((s.width - n.width) / r) * r, p = Math.round((s.height - n.height) / l) * l, d = n.width + u, c = n.height + p, f = i.maxWidth && i.maxWidth < d, g = i.maxHeight && i.maxHeight < c, m = i.minWidth && i.minWidth > d, s = i.minHeight && i.minHeight > c;
          i.grid = a,
          m && (d += r),
          s && (c += l),
          f && (d -= r),
          g && (c -= l),
          /^(se|s|e)$/.test(h) ? (e.size.width = d,
          e.size.height = c) : /^(ne)$/.test(h) ? (e.size.width = d,
          e.size.height = c,
          e.position.top = o.top - p) : /^(sw)$/.test(h) ? (e.size.width = d,
          e.size.height = c,
          e.position.left = o.left - u) : ((c - l <= 0 || d - r <= 0) && (t = e._getPaddingPlusBorderDimensions(this)),
          0 < c - l ? (e.size.height = c,
          e.position.top = o.top - p) : (c = l - t.height,
          e.size.height = c,
          e.position.top = o.top + n.height - c),
          0 < d - r ? (e.size.width = d,
          e.position.left = o.left - u) : (d = r - t.width,
          e.size.width = d,
...
(function(root, factory) {
  ...
  var DATA_DISPLAYCONTROLLER = "displayController"
    ...
    , RAD2DEG = 180 / Math.PI
    , MOUSE_EVENTS = ["click", "dblclick", "mousedown", "mouseup", "mousemove", "mouseover", "mouseout", "mouseenter", "mouseleave", "contextmenu"];
  var session = {
      tooltips: null,
      isTipOpen: false,
      ...
      function positionTipOnElement(element) {
          ...
          if (options.smartPlacement || options.followMouse && element.data(DATA_FORCEDOPEN)) {
              ...
              $.each(priorityList, function(idx, pos) {
                  var collisions = getViewportCollisions(placeTooltip(element, pos), tipElement.outerWidth(), tipElement.outerHeight());
                  finalPlacement = pos;
...
(function(t) {
  ...
  function initMouseDetection(t) {
      ...
      if (mouseDetectionEnabled || t)
          mouseDetectionEnabled && t && ($(document).off(e),
              ...
              mousemove: function(t) {
                  ...
                  if (s) {
                      var o = Math.abs(s.x - e.x)
                        , a = Math.abs(s.y - e.y);
                      if ((o > 0 || a > 0) && 2 >= o && 2 >= a && 300 >= e.timeStamp - s.timeStamp && (mouse = !0,
                      i)) {
      ...
      prototype: {
          ...
          destroy: function(t) {
              ...
              this.$root.find("ul").each(function() {
                  ...
                  t.dataSM("shown-before") && ((i.opts.subMenusMinWidth || i.opts.subMenusMaxWidth) && t.css({
                      width: "",
                      minWidth: "",
                      maxWidth: ""
          ...
          docClick: function(t) {
              ...
              void 0) : ((this.visibleSubMenus.length && !$.contains(this.$root[0], t.target) || $(t.target).closest("a").length) && this.menuHideAll(),
              void 0)
          },
          ...
          getOffset: function(t, e) {
              ...
              return o || 0 === o || (o = e ? t[0].offsetHeight : t[0].offsetWidth),
              i && t.hide().css(i),
              o
          },
          getStartZIndex: function(t) {
              var e = parseInt(this[t ? "$root" : "$firstSub"].css("z-index"));
              return !t && isNaN(e) && (e = parseInt(this.$root.css("z-index"))),
              isNaN(e) ? 1 : e
          },
          ...
          isFixed: function() {
              ...
              return t || this.$root.parentsUntil("body").each(function() {
                  return "fixed" == $(this).css("position") ? (t = !0,
                  !1) : void 0
              }),
              t
          },
          ...
          menuHide: function(t) {
              if (this.$root.triggerHandler("beforehide.smapi", t[0]) !== !1 && (canAnimate && t.stop(!0, !0),
              "none" != t.css("display"))) {
                  var e = function() {
                      t.css("z-index", "")
                  };
                  ...
                  t.dataSM("scroll") && (this.menuScrollStop(t),
                  t.css({
                      "touch-action": "",
                      "-ms-touch-action": "",
                      "-webkit-transform": "",
                  ...
                  this.visibleSubMenus.splice($.inArray(t, this.visibleSubMenus), 1),
          ...
          menuPosition: function(t) {
              ...
              if (g ? (e = M ? d - r - w : w,
              i = this.opts.bottomToTopSubMenus ? -h - T : m + T) : (e = M ? w - r : d - w,
              ...
              this.opts.keepInViewport) {
                  ...
                  g && (I + h > v + S + .49 || v > I) || !g && h > S + .49) {
                      ...
                      }).eq(g && this.opts.bottomToTopSubMenus ? 0 : 1).show(),
                      this.isFixed()) {
                          var C = {};
          ...
          menuScrollStop: function(t) {
              return this.scrollTimeout ? (cancelAnimationFrame(this.scrollTimeout),
              this.scrollTimeout = 0,
              ...
              isTouchEvent(e)) {
                  ...
                  if (this.getClosestMenu(i.target) == t[0]) {
                      ...
                      if (/(start|down)$/i.test(e.type))
                          this.menuScrollStop(t) ? (e.preventDefault(),
                          this.$touchScrollingSub = t) : this.$touchScrollingSub = null,
                          this.menuScrollRefreshData(t),
                          $.extend(s, {
                              touchStartY: i.pageY,
                          ...
                          void 0 !== s.touchY && ((s.momentum = 15 * Math.pow(Math.abs(i.pageY - s.touchStartY) / (e.timeStamp - s.touchStartTime), 2)) && (this.menuScrollStop(t),
                          this.menuScroll(t),
                          e.preventDefault()),
                          delete s.touchY)
                  }
          ...
          menuShow: function(t) {
              ...
              this.$root.triggerHandler("beforefirstshow.smapi", t[0]) !== !1)) && this.$root.triggerHandler("beforeshow.smapi", t[0]) !== !1 && (t.dataSM("shown-before", !0),
              canAnimate && t.stop(!0, !0),
              !t.is(":visible"))) {
                  var e = t.dataSM("parent-a")
                    , i = this.isCollapsible();
                  if ((this.opts.keepHighlighted || i) && e.addClass("highlighted"),
                  i)
