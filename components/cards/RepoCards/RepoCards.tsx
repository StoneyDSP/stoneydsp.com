...
export const repos = [
  ...
  },
  {
    ...
    subtitle:
      'Multi-mode Biquad filter for audio analysis purposes using variable BiLinear transforms, processing precision, and pre-warped co-efficients to achieve high-quality results.',
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      {repos.map(({ title, subtitle, url, icon }) => (
        <Link
          ...
          rel="noreferrer"
        >
          <h3 className="animate-in font-bold opacity-90 group-hover:opacity-100 mb-2 min-h-[40px] lg:min-h-[60px]">
            {title}
          </h3>
          <div className="flex flex-col grow gap-4 justify-between">
            <p className="animate-in text-sm opacity-80 group-hover:opacity-100">{subtitle}</p>
