...
abstract class PressableComponent<
  ...
  Config extends PressableComponent.TypeConfig = PressableComponent.TypeConfig,
  Data extends PressableComponent.Data = PressableComponent.Data,
>
  extends FocusableComponent<Spec, Config, Data>
  implements
    FocusableComponent.ImplementTemplateSpec<PressableComponent.TemplateSpec>
{
  ...
  static override _template(): PressableComponent.Template<PressableComponent.TemplateSpec> {
    ...
    return {
      ...
      collision: true,
      // cursor: "auto",
      /// NOTE: you might not fire the events if the pressable does not have the
      /// highest zIndex!
    };
  }
  ...
  override _handleEnterRelease(
    evt: Parameters<NonNullable<FocusableComponent["_handleEnterRelease"]>>[0]
  ): ReturnType<NonNullable<FocusableComponent["_handleEnterRelease"]>> {
    return true; // TODO: perhaps return a `this.shouldPropagate`?
  }
