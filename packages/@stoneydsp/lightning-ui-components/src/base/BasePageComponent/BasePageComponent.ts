...
>
  extends BaseComponent<Spec, Config>
  implements
    BaseComponent.ImplementTemplateSpec<BasePageComponent.TemplateSpec>
{
  /// ------------------------------------------------------------------ WIDGETS
  ...
  /**
   * @type {BasePageComponent.Data}
   */
  protected override _data: BasePageComponent.Data;
  ...
  override historyState(params: BasePageComponent.HistoryState<Config>): BasePageComponent.HistoryState<Config> {
    if(params) {
      //
      return params
    } else {
...
declare namespace BasePageComponent {
  ...
  export type HistoryState<Config extends TypeConfig = TypeConfig> = Router.HistoryState<Config>
  ...
  export type Constructor<C extends BaseComponent = BaseComponent> = BaseComponent.Constructor<C>
