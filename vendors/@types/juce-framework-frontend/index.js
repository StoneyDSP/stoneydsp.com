...
class PromiseHandler {
  constructor() {
    ...
    /**
     * @type {Map<number, { resolve: (value: any) => any, reject?: (reason: any) => void }>}
     */
  ...
  createPromise() {
    ...
    const result = new Promise((resolve, reject) => {
      const t = { resolve: resolve, reject: reject }
...
export {
  ControlParameterIndexUpdater, getBackendResourceAddress, getComboBoxState, getNativeFunction,
  getSliderState,
  getToggleState
};
