...
export const metadata: Metadata  = {
  ...
  openGraph: {
    ...
    images: [
      ...
      {
        url: 'https://www.stoneydsp.com/images/favicon/android-icon-36x36.png',
        width: '36',
        height: '36',
        type: 'image/png',
        alt: 'Systems, Web, Audio & Graphics',
      ...
      {
        url: 'https://www.stoneydsp.com/images/favicon/android-icon-48x48.png',
        width: '48',
        height:'48',
        type: 'image/png',
        alt: 'Systems, Web, Audio & Graphics',
      ...
      {
        url: 'https://www.stoneydsp.com/images/favicon/android-icon-72x72.png',
        width: '72',
        height: '72',
        type: 'image/png',
        alt: 'Systems, Web, Audio & Graphics',
      ...
      {
        url: 'https://www.stoneydsp.com/images/favicon/android-icon-96x96.png',
        width: '96',
        height: '96',
        type: 'image/png',
        alt: 'Systems, Web, Audio & Graphics',
      ...
      {
        url: 'https://www.stoneydsp.com/images/favicon/android-icon-144x144.png',
        width: '144',
        height: '144',
        type: 'image/png',
        alt: 'Systems, Web, Audio & Graphics',
      ...
      {
        url: 'https://www.stoneydsp.com/images/favicon/android-chrome-192x192.png',
        width: '192',
        height: '192',
        type: 'image/png',
        alt: 'Systems, Web, Audio & Graphics',
