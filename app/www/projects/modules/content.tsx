...
export default async function ModulesContent() {

  const mdx = await mdxFetch('https://raw.githubusercontent.com/nathanjhood/modules/main/README.md')
          ...
          <div className={styles.flexboxgrid}> */}
            ...
            <div className="grid grid-cols-1 gap-4">
              <GitProjectCard
                ...
                linkTo={'https://github.com/nathanjhood/modules.git'}
                altString={'modules'}
                repoName={'modules'}
              />
            </div>
