...
export default async function HostconfigContent() {

  const mdx = await mdxFetch('https://raw.githubusercontent.com/nathanjhood/hostconfig/main/README.md')
          ...
          <div className={styles.flexboxgrid}> */}
            ...
            <div className="grid grid-cols-1 gap-4">
              <GitProjectCard
                ...
                linkTo={'https://github.com/nathanjhood/hostconfig.git'}
                altString={'hostconfig'}
                repoName={'hostconfig'}
              />
            </div>
