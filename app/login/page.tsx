      ...
      <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
        ...
        >
          ...
          <button className="
            ...
            "
          >
            <span className='text-center text-white mb-2'>
              Sign&nbsp;In
            </span>
          </button>
          <button
            formAction={signUp}
            className="transition-colors bg-green-600 hover:bg-purple-400 border border-foreground/20 rounded-md px-4 py-2 mb-2"
          >
            <span className='text-white text-foreground mb-2'>
              Sign&nbsp;Up
            </span>
          </button>
