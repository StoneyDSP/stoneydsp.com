...
export function setHeaders(
  ...
  headers: Readonly<Array<SecurityHeaders>>
) {
...
export const headersCORSNextJs: Readonly<Array<SecurityHeaders>> = [
...
export const headersCORSSupabase: Readonly<Array<SecurityHeaders>> = [
  { name: "Access-Control-Allow-Origin", value: "*" },
  { name: "Access-Control-Allow-Credentials", value: "true" },
  {
    name: "Access-Control-Allow-Methods",
...
export const headersCORSVercel: Readonly<Array<SecurityHeaders>> = [
  { name: "Access-Control-Allow-Origin", value: "*" },
  { name: "Access-Control-Allow-Credentials", value: "true" },
  {
    name: "Access-Control-Allow-Methods",
...
export const headersCacheControl: Readonly<Array<SecurityHeaders>> = [
